...
case `uname` in
  Linux)
   ...
   g++ -std=c++0x -isystem ${GTEST_DIR}/include -pthread -fprofile-arcs -ftest-coverage request_test.cc request.cc ${GTEST_DIR}/src/gtest_main.cc libgtest.a -o request_test
    ...
    g++ -std=c++0x -isystem ${GTEST_DIR}/include -pthread -fprofile-arcs -ftest-coverage static_handler_test.cc not_found_handler.cc request_handler.cc static_handler.cc response.cc request.cc config_parser.cc ${GTEST_DIR}/src/gtest_main.cc libgtest.a -o static_handler_test
    ...
    g++ -std=c++0x -isystem ${GTEST_DIR}/include -pthread -fprofile-arcs -ftest-coverage proxy_handler_test.cc request_handler.cc proxy_handler.cc ${GTEST_DIR}/src/gtest_main.cc libgtest.a response.cc request.cc config_parser.cc -lpthread -lboost_system -o proxy_handler_test
